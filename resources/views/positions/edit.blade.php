        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/position/update')}}" onsubmit="return confirm('{{$lb_confirm_update}}')"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" required autofocus name="name" id="name" class="form-control" value="{{$position->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
