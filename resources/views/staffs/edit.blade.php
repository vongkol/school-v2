    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                    <form action="{{url('/staff/update')}}" class="form-horizontal" method="post" enctype='multipart/form-data'>
                       <div class="row">
                           <div class="col-sm-6">
                               {{csrf_field()}}
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" required autofocus name="first_name" id="first_name" class="form-control" value="{{$staff->first_name}}">
                                   </div>
                               </div>
                               <div class="form-group row">
                                   <label for="family_name" class="control-label col-sm-3">Family Name <span class="text-danger">*</span></label>
                                   <div class="col-sm-9">
                                       <input type="text" name="family_name" id="family_name" required class="form-control" value="{{$staff->family_name}}">
                                   </div>
                               </div>
                               <div class="form-group row">
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text"  name="dob" id="dob" class="form-control" value="{{$staff->dob}}" placeholder="dd/mm/yyyy">
                                   </div>
                               </div>
                               <div class="form-group row">
                                   <label for="pob" class="control-label col-sm-3">{{$lb_pob}}</label>
                                   <div class="col-sm-9">
                                       <input type="text" name="pob" id="pob" class="form-control" value="{{$staff->pob}}">
                                   </div>
                               </div>
                               <div class="form-group row">
                                   <label for="join_date" class="control-label col-sm-3">Join Date <span class="text-danger">*</span></label>
                                   <div class="col-sm-9">
                                   <input type="text"  name="join_date" id="join_date" class="form-control" value="{{$staff->join_date}}" placeholder="dd/mm/yyyy">
                                   </div>
                               </div>
                               <div class="form-group row">
                                   <label for="current_address" class="control-label col-sm-3">Current Address</label>
                                   <div class="col-sm-9">
                                   <input type="text" name="current_address" id="current_address" class="form-control" value="{{$staff->current_address}}">
                                   </div>
                               </div>
                           </div>
                           <div class="col-sm-6">
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" required  name="email" id="email" class="form-control" value="{{$staff->email}}">
                                   </div>
                               </div>
                               <div class="form-group row">
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" name="nationality" id="nationality" required class="form-control" value="{{$staff->nationality}}">
                                   </div>
                               </div>
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text"  name="salary" id="salary" class="form-control" value="{{$staff->salary}}" placeholder="00.00$">
                                   </div>
                               </div>
                               <div class="form-group row">
