        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    ...
                    <a href="{{url('/item')}}" class="btn btn-link btn-sm">{{$lb_back_to_list}}</a> |  <a href="{{url('/item/edit/'.$item->id)}}"  class="btn text-danger btn-link btn-sm"><i class="fa fa-edit"></i>Edit</a>
                </div>
