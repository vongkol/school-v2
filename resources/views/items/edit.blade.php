    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                    <form action="{{url('/item/update')}}" class="form-horizontal" method="post" enctype='multipart/form-data'>
                       <div class="row">
                           <div class="col-sm-6">
                               {{csrf_field()}}
                              <input type="hidden" value="{{$item->id}}" name="id">
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" required autofocus name="name" id="name" class="form-control" value="{{$item->name}}">
                                   </div>
                               </div>
                           ...
                           <div class="col-md-12">
                            <div class="form-group row">
                                   ...
                                   <div class="col-sm-12">
                                       <textarea name="description" class="form-control ckeditor" id="description">{{$item->description}}</textarea>
                                   </div>
                               </div>
                           </div>
                            <div class="col-sm-6">
