...
class CommuneController extends Controller
{
    ...
    {
        $data['communes'] = DB::table('communes')->join('districts', 'communes.district_id', '=', 'districts.id')
                            ->join('provinces', 'communes.province_id', '=', 'provinces.id')
                            ->select('communes.*', 'districts.name as district_name', 'provinces.name as province_name')
